...
async def upload_post(
    ...
    return post_service_obj.upload_post(PostData(image_data=file_data, file_extension=file_extension, caption=caption), user_id=user_id)
...
async def get_post(
    ...
    return post_service_obj.get_post(user_id=user_id)
